  ...
  return (
    <div className="space-y-5">
      ...
      <a
        ...
        className="w-full flex items-center justify-center gap-3 px-4 h-12 border border-border rounded-xl hover:bg-muted hover:border-border-strong transition-all duration-200 font-semibold text-sm text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
      >
