    ...
    return (
      <div className="space-y-5">
        ...
        <button
          ...
          className="w-full text-sm text-primary hover:text-primary-hover font-semibold"
        >
          Voltar ao login
        </button>
      </div>
    ...
    <div className="space-y-5">
      ...
      <div className="text-center">
        <Link
          ...
          className="text-sm text-primary hover:text-primary-hover font-semibold hover:underline"
        >
          Entrar sem senha
        </Link>
      </div>
