...
function MeuVizinhoPanel() {
  return (
    <div
      ...
      style={{ background: "linear-gradient(145deg, #0c1a36 0%, #1a3377 45%, #0f4a2e 100%)" }}
    >
      ...
      {/* Decorative orbs — float-animated */}
        ...
        <div className="space-y-5">
          ...
          <h2 className="text-3xl xl:text-4xl font-extrabold leading-tight tracking-tight">
            ...
            <span
              ...
              style={{
                backgroundImage: "linear-gradient(135deg, #93c5fd 0%, #6ee7b7 40%, #a5f3fc 70%, #93c5fd 100%)",
              }}
            >
              na palma da mão.
            </span>
          ...
          <p className="text-sm text-white/65 leading-relaxed max-w-[30ch]">
            Marketplace, grupos, eventos e muito mais — com os vizinhos do seu bairro.
          </p>
        </div>
